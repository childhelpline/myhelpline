...
urlpatterns = [
    ...
    url('^pivot/$', views.pivot, name='pivot'),
    url('^leta/$', views.leta, name='leta'),
    url('^success/$', views.success, name='success'),
    url('^locations/$', views.locations, name='locations'),
    ...
    url('^integrate/$', views.send_external, name='dcs_push'),
    ...
    url('^sources/(?P<source>\w+)/(?P<itemid>\w+)/$', views.sources, name='mysources'),
    ...
    url('^manageusers/(?P<action>\w+)/(?P<action_item>\w+)/$', views.manage_users, name='manageusers'),
    ...
    url('^currentuser.csv/$', views.current_user, name='current_user'),
    ...
    url(r'^generalreports/(?P<report>\w+)/$', views.general_reports, name='general'),
